...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : t(
          ((e = 'undefined' != typeof globalThis ? globalThis : e || self).adminlte = {}),
          e.jQuery
        );
})(this, function (e, t) {
  'use strict';
      ...
      return (
                ...
                function (t) {
                  (e._settings.loadInContent &&
                    ('' !== e._settings.sourceSelector &&
                      (t = n.default(t).find(e._settings.sourceSelector).html()),
        ...
        (t._addOverlay = function () {
          (this._parent.append(this._overlay),
            n.default(this._element).trigger(n.default.Event('overlay.added.lte.cardrefresh')));
        }),
        (t._removeOverlay = function () {
          (this._parent.find(this._overlay).remove(),
            n.default(this._element).trigger(n.default.Event('overlay.removed.lte.cardrefresh')));
        }),
        (t._init = function () {
          var e = this;
          (n
        ...
        (e._jQueryInterface = function (t) {
          ...
          (a ||
            ...
            'string' == typeof t && /load/.test(t) ? a[t]() : a._init(n.default(this)));
        }),
        e
      );
    })();
      ...
      return (
        ...
        (t.remove = function () {
          (this._parent.slideUp(),
            this._element.trigger(n.default.Event('removed.lte.cardwidget'), this._parent));
        }),
        (t.toggle = function () {
        ...
        (e._jQueryInterface = function (t) {
          ...
          (a ||
            ...
            'string' == typeof t &&
            /collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/.test(t)
              ? a[t]()
      ...
      return (
        ...
        (t._fixScrollHeight = function () {
          ...
          if (e.hasClass(R)) {
            ...
            if (0 === o && 0 === i)
              ...
              o <= a.header
                ? !1 === l
                  ? (t.css('top', a.header - o), r.css('height', a.window - (a.header - o)))
                  : t.css('top', a.header)
                : !1 === l
        ...
        (t._fixHeight = function () {
          ...
          if (e.hasClass(R)) {
            var a = n.default(window).height(),
              ...
              l = a - i;
            (this._isFooterFixed() && 'fixed' === n.default(F).css('position') && (l = a - i - o),
              t.css('height', l),
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if ((a || ((a = new e(this, i)), n.default(this).data(S, a)), 'undefined' === a[t]))
      ...
      return (
        (e.prototype.toggle = function () {
          (n
            ...
            n.default(this._element).trigger(n.default.Event('toggled.lte.directchat')));
        }),
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            var a = n.default(this).data(O);
        ...
        (t.toggleSubmenu = function () {
          (this._element.siblings().show().toggleClass('show'),
            this._element.next().hasClass('show') ||
              this._element.parents(J).first().find('.show').removeClass('show').hide(),
            this._element
      ...
      return (
        (t.init = function () {
          n.default(Z).each(function (e, t) {
            ...
            'true' === a
              ? i.show()
              : 'false' === a && (i.hide(), i.parent().parent().addClass('d-none'));
          });
        }),
  ...
  var ae = 'Fullscreen',
    ...
    le = oe + ' i',
    se = { minimizeIcon: 'fa-compress-arrows-alt', maximizeIcon: 'fa-expand-arrows-alt' },
    re = (function () {
      function e(e, t) {
      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          ...
          (n.default(this).data(ne, 'object' == typeof t ? t : a),
            'string' == typeof t && /toggle|toggleIcon|fullscreen|windowed/.test(t)
              ? o[t]()
              : o.init());
        }),
        e
      ...
      return (
        ...
        (t.openTabSidebar = function (e, t) {
          ...
          if ('#' !== o && '' !== o && void 0 !== o) {
            ...
            ((!this._config.allowDuplicates && 0 === n.default('#' + s).length) ||
              this._config.allowDuplicates) &&
        ...
        (t.removeActiveTab = function (e, t) {
          if ('all' == e) (n.default(ve).remove(), n.default(we).remove(), n.default(ye).show());
            ...
            if (
              (i.remove(),
              n.default('#' + s).remove(),
              n.default(be).children().length == n.default(ye + ', ' + Ce).length)
            )
              n.default(ye).show();
            else {
              var r = l - 1;
        ...
        (t._setupListeners = function () {
          ...
          (n.default(window).on('resize', function () {
            ...
            n.default(he).hasClass(Se) &&
              (n
                .default(document)
                .on('click', xe + ', .sidebar-search-results .list-group-item', function (t) {
            ...
            n.default(document).on('click', '[data-widget="iframe-close"]', function (t) {
              ...
              ('I' == a.nodeName && (a = t.target.offsetParent),
                e.removeActiveTab(
                  a.attributes['data-type'] ? a.attributes['data-type'].nodeValue : null,
                  a
                ));
            }),
        ...
        (t._setItemActive = function (e) {
          ...
          (t.each(function (e, t) {
            ...
            i.each(function (e, t) {
              (n.default(t).addClass('active'),
                n.default(t).parents('.nav-treeview').prevAll('.nav-link').addClass('active'));
            }));
        }),
      ...
      return (
        ...
        (t._init = function () {
          ...
          (this.fixLayoutHeight(),
            ...
            n.default(Le).on('collapsed.lte.treeview expanded.lte.treeview', function () {
              e.fixLayoutHeight();
            }),
        ...
        (e._jQueryInterface = function (t) {
          return (
            ...
            this.each(function () {
              ...
              (a || ((a = new e(n.default(this), i)), n.default(this).data(He, a)),
                'init' === t || '' === t
                  ? a._init()
                  : ('fixLayoutHeight' !== t && 'fixLoginRegisterHeight' !== t) || a[t]());
            })
          );
        }),
        e
      ...
      return (
        (t.expand = function () {
          ...
          (this._options.autoCollapseSize &&
            ...
            this._options.enableRemember && localStorage.setItem('remember' + Ne, Je),
        ...
        (t.collapse = function () {
          ...
          (this._options.autoCollapseSize &&
            ...
            t.addClass($e),
            this._options.enableRemember && localStorage.setItem('remember' + Ne, $e),
        ...
        (t.autoCollapse = function (e) {
          if ((void 0 === e && (e = !1), this._options.autoCollapseSize)) {
            ...
            n.default(window).width() <= this._options.autoCollapseSize
              ...
              : !0 === e && (t.hasClass(Je) ? t.removeClass(Je) : t.hasClass(Ve) && this.expand());
          }
        }),
        (t.remember = function () {
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            (a || ((a = new e(this, i)), n.default(this).data(Oe, a)),
              'string' == typeof t && /collapse|expand|toggle/.test(t) && a[t]());
          });
        }),
        e
      );
  ...
  (n.default(document).on('click', Ue, function (e) {
    ...
    ('pushmenu' !== n.default(t).data('widget') && (t = n.default(t).closest(Ue)),
      ...
      return (
        ...
        (a._parseItem = function (e, t) {
          ...
          if ((void 0 === t && (t = []), !n.default(e).hasClass('nav-header'))) {
            ...
            if (((i.name = this._trimText(r)), (i.link = s), (i.path = t), 0 === l.length))
              ct.push(i);
            else {
        ...
        (e._jQueryInterface = function (t) {
          ...
          (n.default(this).data(Ye, 'object' == typeof t ? t : a),
            'string' == typeof t && /init|toggle|close|open|search/.test(t) ? o[t]() : o.init());
        }),
        e
      );
    })();
  (n.default(document).on('click', st, function (e) {
    ...
    n.default(document).on('keydown', ft, function (e) {
      ...
      (38 == e.keyCode &&
        (e.preventDefault(), t.is(':first-child') ? t.siblings().last().focus() : t.prev().focus()),
        40 == e.keyCode &&
          (e.preventDefault(),
          t.is(':last-child') ? t.siblings().first().focus() : t.next().focus()));
    }),
    n.default(window).on('load', function () {
  ...
  var gt = 'NavbarSearch',
    ...
    Ct = (function () {
      ...
      return (
        (t.open = function () {
          (n.default(this._config.target).css('display', 'flex').hide().fadeIn().addClass(bt),
            n.default(this._config.target + ' ' + _t).focus());
        }),
        (t.close = function () {
          (n.default(this._config.target).fadeOut().removeClass(bt),
            this._config.resetOnClose && n.default(this._config.target + ' ' + _t).val(''));
        }),
        (t.toggle = function () {
      ...
      return (
        (t.create = function () {
          ...
          if (null != this._config.image) {
            ...
            (null != this._config.imageHeight && a.height(this._config.imageHeight).width('auto'),
              t.append(a));
          }
          if (
            (null != this._config.icon &&
              t.append(n.default('<i />').addClass('mr-2').addClass(this._config.icon)),
            null != this._config.title &&
              t.append(n.default('<strong />').addClass('mr-auto').html(this._config.title)),
      ...
      return (
        (t.toggle = function (e) {
          (e.parents('li').toggleClass(Ft),
            n.default(e).prop('checked') ? this.check(e) : this.unCheck(n.default(e)));
        }),
        (t.check = function (e) {
  ...
  var Dt = 'Treeview',
    ...
    $t = (function () {
      ...
      return (
        (t.init = function () {
          (n.default('.nav-item.menu-open .nav-treeview.menu-open').css('display', 'block'),
