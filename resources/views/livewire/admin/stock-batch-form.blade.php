    ...
    @if ($actionType === 'add')
      <form wire:submit="submit">
        ...
        <div class="form-row">
            ...
            @if ($showCategoryModal)
              <div class="mt-2 p-2 border rounded" style="background-color: #f8f9fa">
                <div class="form-group mb-2">
                  ...
                  <input
                    type="text"
                    wire:model.defer="newCategoryCode"
                ...
                <div class="form-group mb-0">
                  ...
                  <button
                    ...
                    wire:click.prevent="$set('showCategoryModal', false)"
                  >
          ...
          <div class="form-group col-md-6">
            <label for="addSubcategory">Subkategori</label>
            <div class="input-group">
            ...
            @if ($showSubcategoryModal)
              <div class="mt-2 p-2 border rounded" style="background-color: #f8f9fa">
                <div class="form-group mb-2">
                  ...
                  <input
                    type="text"
                    wire:model.defer="newSubcategoryCode"
                    class="form-control form-control-sm"
                ...
                <div class="form-group mb-2">
                  ...
                  <input
                    type="text"
                    wire:model.defer="newSubcategoryName"
                    class="form-control form-control-sm"
                ...
                <div class="form-group mb-0">
                  ...
                  <button
                    class="btn btn-secondary btn-sm"
                    wire:click.prevent="$set('showSubcategoryModal', false)"
                  >
                    <i class="fas fa-times"></i>
                    Batal
                  </button>
          ...
          <div class="form-group col-md-6">
            ...
            @if ($existingNames && count($existingNames) > 0)
              ...
              <small class="text-muted d-block mt-1">
                ...
                Pilih dari dropdown atau ketik nama baru. Kosongkan untuk auto-generate.
              </small>
            @else
              <input
                type="text"
              ...
              <small class="text-muted d-block mt-1">
                <i class="fas fa-info-circle"></i>
                Kosongkan untuk auto-generate nama tumpukan (Tumpukan 1, 2, dst).
              </small>
            @endif
            @error('namaTumpukan')
              <span class="text-danger small">{{ $message }}</span>
