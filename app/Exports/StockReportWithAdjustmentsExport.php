...
class StockSheet implements FromArray, WithColumnWidths, WithHeadings, WithStyles
{
    protected $data;
...
class TotalStockSheet implements FromArray, WithColumnWidths, WithStyles
{
    protected $stokTokoData;
...
class AdjustmentSheet implements FromArray, WithColumnWidths, WithStyles
{
    protected $data;
